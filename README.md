...
| Decor                | Half wall, Rug, large plant (among them a golden bamboo and a weeping fig), small plant, wall mirror, wall clock, vase, books, curtain, Christmas tree (a fir or a bare winter tree strung with lights), aquarium (on a cabinet or a floor standing column) |
