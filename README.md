...
| Decor                | Half wall, Rug, large plant, small plant, wall mirror, wall clock, vase, books, curtain, Christmas tree (fir or slim pine), aquarium (cabinet or rimless stand)                                                                       |
| Media                | TV, wall TV, soundbar, speaker, floor speaker, monitor, game console, projector, portable projector, projector screen                                                                                                                 |
| Climate              | Radiator, air conditioner, ceiling fan, floor fan (pedestal or disc), air purifier, humidifier, thermostat, fireplace (linear or wood stove)                                                                                          |
| Windows and doors    | Blind (venetian or roller shutter), window (casement, box sash, top hung, sliding or steel grid), door (flush, panelled or glazed), sliding door (solid or glass), garage door (sectional or roller), awning (folding arm or pergola) |
| Security and sensors | Camera, doorbell, motion sensor, smoke detector, alarm panel, smart lock, air quality sensor                                                                                                                                          |
| Smart home           | Robot vacuum, pet feeder (food or water fountain), water heater (combi boiler or tank)                                                                                                                                                |
| Garden and outdoor   | Hot tub (square spa or barrel), pool (decked or frame), sprinkler (pop up rotor, oscillating bar or drip line), robot lawn mower                                                                                                      |
...
- Fans spin, faster at a higher level, and washing machines turn their drum. Air conditioners, air purifiers and humidifiers breathe out a plume.
...
- Fridges and dishwashers open their doors, upper cabinets open theirs, a toilet lifts its lid, and kettles and coffee machines steam.
- Taps run water into kitchen sinks and basins and the sink slowly fills, a bath fills to a bathing level while its tap runs, and a shower rains from its head.
- Desks rise to standing height, taking everything on them along, and beds raise their head end.
- Fireplaces and stoves burn, a Christmas tree twinkles its lights, an aquarium lights up with fish swimming and bubbles rising, a pet feeder drops kibble into its bowl, a fountain wells over its dome, and a water heater lights its flame or display.
- Hot tubs light up, bubble and steam, pools light their water, sprinklers throw a sweeping arc or drip into spreading wet patches, and a robot lawn mower leaves its garage to mow the room the way a robot vacuum does.
- Thermostats, alarm panels and air quality sensors light their display. A smart lock turns its knob upright when locked, a motion sensor glows red when it sees someone, and a camera lights its LED.
