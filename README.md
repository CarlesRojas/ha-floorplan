...
| Decor                | Half wall, Rug, large plant, small plant, wall mirror, wall clock, vase, books, curtain                                                                                            |
...
| Windows and doors    | Blind (venetian or roller shutter), window, door (flush, panelled or glazed), sliding door (solid or glass), garage door (sectional or roller), awning (folding arm or Dutch hood) |
...
- Fans spin, faster at a higher level, with a blur round their blades, and washing machines turn their drum. Air conditioners, air purifiers and humidifiers breathe out a plume.
...
- Fridges light their display, dishwashers throw a spot on the floor, and kettles and coffee machines steam.
- Taps run water into kitchen sinks and basins, a bath fills slowly while its tap runs, and a shower rains from its head. Wall cabinets light the counter under them and a wall mirror glows round its edge.
