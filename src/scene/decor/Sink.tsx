  ...
  if (style === 'belfast') {
    ...
    return (
      <group>
        ...
        <Fill on={fit.on} share={0.35} rate={0.5} floor={top - b.depth} top={top} w={b.w} l={b.d} r={b.r} />
    ...
    return (
      <group>
        ...
        <group position={[b.x, 0, b.z]}>
          <Fill on={fit.on} share={0.35} rate={0.5} floor={-b.depth + 0.012} top={0} w={b.w} l={b.d} r={b.r} />
        </group>
    ...
    <group>
      {plan.bowls.map((b, i) => (
        <group key={i}>
          ...
          {/* Only the bowl under the tap fills. */}
          {i === 0 && (
            <group position={[b.x, 0, b.z]}>
              <Fill
                on={fit.on}
