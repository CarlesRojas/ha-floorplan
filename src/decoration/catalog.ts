...
export const DECORATION_KINDS: DecorationKind[] = [
  ...
  kind(
    ...
    'Coffee machine',
    'floor',
    [width(0.36, 0.25, 0.5), depth(0.45, 0.3, 0.55), height(0.38, 0.28, 0.5), lift(0.92)],
  ...
  kind(
    ...
    { body: '#2b2c2d', fittings: SCANDI.walnut },
  ...
  kind(
    ...
    [
      { id: 'staghorn', label: 'Staghorn fern' },
      {
        ...
        materials: { mount: 'metal', moss: 'matte', leaves: 'wood', accent: 'matte' },
        params: { width: 0.28 },
      },
      {
        id: 'moss',
        ...
        materials: { mount: 'wood', moss: 'matte', leaves: 'matte', accent: 'matte' },
